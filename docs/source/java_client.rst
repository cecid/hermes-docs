...
For information about installing Hermes 2 and communicating with Hermes 2 using an external application, please refer to :doc:`installation` and :doc:`<Communicating with Hermes 2 Using WS>`.
...
* :doc:`<Communicating with Hermes 2 Using WS>`
